...
function ContactMe() {
  ...
  return (
    <div id='contactme' >
      <div className="flex flex-col justify-center items-center mt-40 mb-5">
        <p className="text-lg text-neutral-400">Get in touch!</p>
        <h1 className="text-5xl font-semibold ">Contact Me</h1>
        <p className='text-lg text-neutral-400 m-2'>Please fill out the form below to discuss any work opportunities</p>
      </div>
      <div className='flex flex-col justify-around items-center'>
      <form ref={form} onSubmit={sendEmail} className=' flex flex-col w-1/2 justify-around items-center rounded-lg p-2   ' >
